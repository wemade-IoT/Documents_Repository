...
| EP08 | Arquitectura e Implementación Técnica | Como equipo de desarrollo, queremos implementar la infraestructura técnica necesaria para soportar las funcionalidades del sistema de monitoreo y automatización de plantas. | | |
...
| HU16 | Edición de Planta | Como usuario domestico, quiero editar la información de mis plantas para poder cambiar el nombre o algún dato ingresado erróneamente. | **Escenario 1:** Modificación de datos básicos <br>Dado que el usuario se encuentra en la vista de "plantas" <br>Cuando presiona el card de la planta, y presiona el icono del lápiz <br>Entonces aparece un textbox que permite reingresar ciertos datos modificables. <br><br>**Escenario 2:** Actualización de información de cuidados <br>Dado que el usuario necesita cambiar información sobre el cuidado de la planta <br>Cuando accede a la sección de edición de cuidados <br>Entonces puede modificar datos como frecuencia de riego o exposición solar recomendada. | EP02 |
| HU17 | Eliminación de Planta | Como usuario domestico, quiero eliminar mi planta para poder liberar espacio para otra. | **Escenario 1:** Confirmación de eliminación <br>Dado que el usuario se encuentra en la vista de "plantas" <br>Cuando presiona el card de la planta, y presiona el icono del basurero <br>Entonces aparece un diálogo informando que se borrarán los datos permanentemente, y al presionarlo se eliminan los datos. <br><br>**Escenario 2:** Cancelación de eliminación <br>Dado que el usuario inicia el proceso de eliminación <br>Cuando decide cancelar la acción en el diálogo de confirmación <br>Entonces la planta no se elimina y regresa a la vista anterior. | EP02 |
| HU18 | Registro de plantaciones empresarial | Como usuario Empresarial, quiero registrar las plantaciones para poder tener información del cultivo. | **Escenario 1:** Registro exitoso de plantación <br>Dado que el usuario se encuentra en la vista de "plantaciones" <br>Cuando utiliza el botón de agregar plantación, y agrega la información del área que cubre la plantación e información adicional en un formulario <br>Entonces al presionar aceptar se muestra un diálogo de confirmación y luego la nueva plantación en la vista. <br><br>**Escenario 2:** Importación masiva de plantaciones <br>Dado que el usuario tiene un archivo con datos de múltiples plantaciones <br>Cuando selecciona la opción de importar plantaciones y carga el archivo <br>Entonces el sistema valida y registra todas las plantaciones válidas. | EP02 |
| HU19 | Recibir alertas sobre el estado de plantas | Como usuario doméstico, quiero recibir notificaciones automáticas ante cualquier cambio significativo en el estado de mis plantas, para poder monitorearlas y tomar acciones a tiempo que aseguren su buen cuidado. | **Escenario 1:** Notificación por cambio significativo <br>Dado que el usuario doméstico tiene activadas las notificaciones <br>Cuando se detecta un cambio significativo en el estado de alguna de sus plantas <br>Entonces el usuario recibe una notificación con la información detallada del cambio y puede visualizar el nuevo estado de la planta afectada. <br><br>**Escenario 2:** Configuración de umbrales de notificación <br>Dado que el usuario desea personalizar sus alertas <br>Cuando accede a la configuración de notificaciones <br>Entonces puede establecer umbrales personalizados para cada tipo de alerta. | EP04 |
