...
| HU15    | Registro de Planta                                  | Como usuario domestico, quiero registrar mis plantas para poder tener información especifica de estas.                                                                                                                   | Dado que me encuentro en la vista de "plantas" , <br> Cuando utilizo el botón de agregar planta, y agrego la información necesaria en un formulario, <br> Entonces al presionar aceptar se muestra la nueva planta en la vista.                                                                                                                                                       | EP05                      | 
